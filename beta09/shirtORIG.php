...
<div class="headercontainer">
    ...
    <div class="clear">&nbsp;</div>
    <div class="helpbutton"><a href="help.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('help','','images/home/helpbuttonon.png',1)" class="mb"><img src="images/home/helpbutton.png" width="458" height="66" id="help" name="help"/></a>
    </div>
...
<div class="maincontainershirt">
    ...
    <div class="biglalapodlaunchcollection">
        ...
        <div class="bigpic">
        <span class="fotoborder"><img src="../../blog/wp-content/uploads/looklalaweb/tshirtid<?php print $id ?>/bigfotomodel.jpg"  /></span>
      </div>
        
        <div class="smallpic">
        <table width="200" border="0" cellpadding="5">
          <tr>
            <td><span class="fotoborder"><img src="../../blog/wp-content/uploads/looklalaweb/tshirtid<?php print $id ?>/smallfotomodel.png" width="166" height="194" /></span></td>
            <td><span class="fotoborder"><img src="../../blog/wp-content/uploads/looklalaweb/tshirtid<?php print $id ?>/smallfotomodel2.png" width="196" height="197" /></span></td>
            <td class="coll">&nbsp;</td>
            <td>
...
?>
  ...
  <div class="clear">&nbsp;</div>
	<div class="thirdpod"><div class="sharetext"><table width="286" border="0" cellpadding="0">
  <tr>
    <td width="171"><a name="fb_share" type="button_count" share_url="<?php print myUrlEncode(selfURL());?>" href="http://www.facebook.com/sharer.php">Share</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script>
     ...
     <td width="109"><script type="text/javascript">
			size = 'small';
			username = 'looklalacom';
			</script>
			<script type="text/javascript" src="http://www.retweet.com/static/retweets.js"></script></td>     
  </tr>
</table>
&nbsp;
