...
//** Mar 17th, 09'- Custom mode that fades panels in and out onMouseover.

var stepcarousel={
	ajaxloadingmsg: '<div style="margin: 1em; font-weight: bold"><img src="ajaxloadr.gif" style="vertical-align: middle" /> Fetching Content. Please wait...</div>', //customize HTML to show while fetching Ajax content
	defaultbuttonsfade: [0.4, 1], //Fade degree for disabled nav buttons (0=completely transparent, 1=completely opaque)
	panelfade: [0.3, 1],
	configholder: {},
	...
	alignpanels:function($, config){
		...
		config.$panels.css({opacity:stepcarousel.panelfade[0]})
		config.$panels.hover(
		function(){
			$(this).stop().animate({opacity:stepcarousel.panelfade[1]})
		},
		function(){
			$(this).stop().animate({opacity:stepcarousel.panelfade[0]})
		}
		)
		config.oninit()
